...
Route::group(['middleware' => ['auth', 'checkrole']], function () {
    ...
    Route::post('admin/category-active/{id}', 'CategoriesController@activeCategories')->name('active.categories');
});
...
Route::get('ratings/{id}','RatingController@delete')->name('rating.delete');
...
Route::group(['namespace' => 'frontend'], function () {
    ...
    //Dánh giá
    Route::post('ratings','CommentController@Ratings')->name('get.ratings');
