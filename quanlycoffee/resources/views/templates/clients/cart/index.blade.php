            ...
            <div class="row">
                ...
                <div class="col-12 col-md-12 col-lg-5">
                    ...
                    <div class="cart_action">
                        <ul>
                            <li><button type="submit" class="btn btn-checkout @if(Auth::guard('customer')->check())  @else jsLogin @endif">Thanh toán</button></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                submitOrder.addEventListener('submit', (e) => {
                    ...
                    if (loca) {
                        if (!input.value || !loca.value) {
                            ...
                            alert('Vui lòng nhập địa chỉ đầy đủ hoặc không vận chuyển.');
                            console.log(false);
                        } else {
                            e.preventDefault();
                            e.stopImmediatePropagation();
                ...
                input.addEventListener('input', (e) => {
                    ...
                    if (e.target.parentElement.classList.contains('province')) {
                        let filter = this.dataLocation.province.filter(province => {
                            return province.province_name.toLowerCase().includes(
                                keyword);
                        })
                    ...
                    if (e.target.parentElement.classList.contains('district')) {
                        let filter = this.dataLocation.district.filter(district => {
                            return district.district_name.toLowerCase().includes(
                                keyword);
                        })
