...
<script>
window.onload = () => {
    toastr.success("{{session()->get('successRating')}}");
}
</script>
@endif
            ...
            @if ($product)
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-12 col-sm-12">
                        ...
                        <div class="img-detail"><img src="{{ asset('uploads/product/' . $product->hinhanh) }}" alt="">
                        </div>
                    </div>
                        ...
                        <div class="woo_pr_detail">
                                        ...
                                        @foreach ($product->size as $key => $value)
                                            <div class="custom-varient custom-size">
                                                <input type="radio" class="custom-control-input" name="sizeRadio"
                                                    id="sizeRadioOne{{ $value->id }}" value="{{ $value->id }}"
                                                    data-toggle="form-caption" data-target="#sizeCaption"
                                                    {{ $key == 0 ? 'checked' : '' }}>
                                                <label class="custom-control-label"
                                                    for="sizeRadioOne{{ $value->id }}">{{ $value->size_name }}<span
                                                        class="price-plus"> +
                            ...
                            <div class="social mt-4 d-flex align-items-center">
                                <div class="item-social">
                                    <div class="fb-like" data-href="{{ $meta['url'] }}" data-width="100px"
                                ...
                                <div class="custom-tab style-1">
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="description-tab" data-toggle="tab"
                                                ...
                                                aria-selected="true" aria-expanded="true">Thông
                                                tin</a>
                                        </li>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="reviews-tab" data-toggle="tab" href="#reviews"
                                                ...
                                                aria-expanded="false">Bình luận</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="reviews-faceboook-tab" data-toggle="tab"
                                                href="#reviews-faceboook" role="tab"
                                                aria-controls="reviews-faceboook" aria-selected="false"
                                                aria-expanded="false">Bình luận trên facebook</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="reviews-rating-tab" data-toggle="tab"
                                                href="#reviews-rating" role="tab"
                                                aria-controls="reviews-rating" aria-selected="false"
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade" id="reviews" role="tabpanel"
                                            aria-labelledby="reviews-tab" aria-expanded="false">
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <div
                                                                                                                    class="col-sm-12">
                                                                                                                    @if ($reply->id_khachhang === get_user('customer', 'id'))
                                        ...
                                        <div class="tab-pane fade " id="reviews-rating" role="tabpanel"
                                            aria-labelledby="reviews-rating" aria-expanded="true">
                                            <div class="review-wrapper">
                                                <div class="review-wrapper-body">
                                                    <ul class="review-list">
                                                        @if (isset($ratings))
                                                                        ...
                                                                        <div class="review-body">
                                                                            ...
                                                                            <div class="review-content">
                                                                                <div class="review-info">
                                                                                    ...
                                                                                    <div class="review-comment-date">
                                                                                        <div class="review-date">
                                                                                            <span>{{ toTime($value->created_at) }}</span>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <p>{{ $value->r_content }}</p>
                                                ...
                                                @if (get_user('customer', 'id'))
                                                    <form class="FormRating" method="POST"
                                                        action="{{ route('get.ratings') }}">
                                                        @csrf
                                                        <div class="review-wrapper-body">
                                                            <div class="row">
                                                                <div class="viewStar">
                                                                    <div class="star_num">
                                                                        <select name="r_number" style="display: none">
                                                                            <option value=""></option>
                                                                ...
                                                                <input type="text" value="{{ $product->id }}"
                                                                    name="r_product_id" hidden>
                                                                <div class="col-sm-12 form-group">
                                                                    <textarea class="form-control height-110 content-commment" name="content" placeholder="Nội dung ..."></textarea>
                                                                </div>
                                                                <div class="col-sm-12">
                                                                    <button type="submit"
                                ...
                                <div class="item">
                                    <div class="woo_product_grid">
                                        ...
                                        <div class="woo_product_thumb">
                                            <img src="{{ asset('uploads/product/' . $value->hinhanh) }}"
                                                class="img-fluid" alt="" />
                                        </div>
                                        <div class="woo_product_caption center">
                                            <div class="woo_title">
                                                <h4 class="woo_pro_title"><a
                                                        href="{{ route('detail', $value->slug) }}">{{ $value->tensp }}</a>
                                                </h4>
                                            </div>
                                            <div class="woo_price ">
                                                <h6>{{ currency_format($value->giaban) }}<span class="less_price"></span>
                                                </h6>
                                                <a href="javascript:" class="btn-plus quickView"
                                                    data-id="{{ $value->id }}"><i class="fa fa-plus-circle"
