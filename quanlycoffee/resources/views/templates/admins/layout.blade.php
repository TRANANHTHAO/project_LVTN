    ...
    <div class="wrapper">
        <nav id="sidebar" class="sidebar js-sidebar">
            <div class="sidebar-content js-simplebar">
                ...
                <div class="logo sidebar-brand d-flex justify-content-between">
                    <a class="large_logo" href="#"><img src="{{ asset('img/logo.png') }}" alt=""></a>
                </div>
                <ul class="sidebar-nav" id="menuAdmin">
                    <li class="sidebar-item" value="dashboard">
                        <a class="sidebar-link" href="{{ route('showDashboard') }} ">
                            <i class="icon-menu" data-feather="user"></i>
                    ...
                    <li class="sidebar-item" value="shipping">
                        <a class="sidebar-link" href="{{ route('get.shipping') }}">
                            <i class="fa fa-truck icon-menu" aria-hidden="true"></i>
                    ...
                    <li class="sidebar-item list_order">
                        <a class="sidebar-link" href="{{ route('get.typepost') }}">
                            <i class="fa fa-caret-square-o-left icon-menu" aria-hidden="true"></i>
                    ...
                    <li class="sidebar-item list_order">
                        <a class="sidebar-link" href="{{ route('get.order', 'receive') }}">
                            <i class="fa fa-spinner icon-menu" aria-hidden="true"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('get.order', 'process') }}">
                            <i class="fa fa-refresh icon-menu" aria-hidden="true"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('get.order', 'success') }}">
                            <i class="fa fa-check icon-menu" aria-hidden="true"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('get.order', 'cancel') }}">
                            <i class="fa fa-ban icon-menu" aria-hidden="true"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link " href="{{ route('get.contact') }}">
                            <i class="fa fa-envelope-o icon-menu" aria-hidden="true"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('rating.index') }}">
                            <i class="fa fa-star icon-menu"></i>
                            <span class="align-middle">Đánh giá</span>
                        </a>
                    </li>
