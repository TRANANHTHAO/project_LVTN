...
<body>
    ...
    <body class="align">
        ...
        <div class="grid">
            ...
            <h3 style="color: #ffff; font-size: 30px; font-weight: bold; text-align: center;">ĐĂNG NHẬP</h3>
            <form action="{{ route('authlogin') }}" method="post" class="form login">
                ...
                <div class="form__field">
                    ...
                    <input autocomplete="username" id="login__username" type="text" name="email"
            ...
            <p class="text--center">Quên mật khẩu ? <a href="{{ route('viewinputmail') }}">Tạo mật khẩu mới</a> <svg
                    class="icon">
